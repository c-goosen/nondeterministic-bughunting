...
| Q1b | Infrastructure, deployment & operational controls (ground in IaC: Dockerfiles, Terraform, k8s, CI) | section 1 "where it runs", section 3 infra trust boundaries, section 4 `controls`, section 8 |
