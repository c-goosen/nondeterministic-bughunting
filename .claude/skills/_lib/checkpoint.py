...
"""Checkpoint helper for the runbook skills (security-vuln-scan, security-triage, security-threat-model).
...
--key defaults to "phase" (security-vuln-scan, security-triage). Pass --key stage for
security-threat-model bootstrap. progress.json schema:
